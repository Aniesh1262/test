...
const Dashboard = () => {
    ...
    console.log("all Audis", allLocationAudis);
    console.log("Locations Audi shows", allLocationAudiShows);
    ...
    console.log("selected location", selectedLocation, selectedAudi);
    return (
        <>
