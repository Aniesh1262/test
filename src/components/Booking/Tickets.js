        ...
        <div className="center row">
            ...
            <div style={{ display: "flex", flexDirection: "column" }} className="col-4">
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", alignItems: "flex-end", marginTop: 160, marginRight: 20 }}>
                    ...
                    <Link to="/cart" state={{ from: "tickets", tickets: { vip: vipTickets, firstClass: firstClassTickets, secondClass: secondClassTickets } }}>
                        <button className="btn btn-success can-con-button" disabled={vipTickets == 0 && firstClassTickets == 0 && secondClassTickets == 0}>
                            Continue
                        </button>
                    </Link>
                </div>
